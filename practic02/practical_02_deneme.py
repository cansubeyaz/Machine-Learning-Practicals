...
if exr0 :
    red_rgb, red_lab = read_to_vector(r'C:\Users\Lenovo\Desktop\PAML_2024\data\colour_snippets\red\*.png')
    grn_rgb, grn_lab = read_to_vector(r'C:\Users\Lenovo\Desktop\PAML_2024\data\colour_snippets\green\*.png')
...
if exr1:
    data = pd.read_csv(r"C:\Users\Lenovo\Desktop\PAML_2024\data\housing.csv")
