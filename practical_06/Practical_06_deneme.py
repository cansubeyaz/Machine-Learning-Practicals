...
if exr0:
    with open(r'C:\Users\cansu\OneDrive\Desktop\PAML_2024\practical_06\mvg_outlier.pkl', 'rb') as fid:
...
if exr2:
    ...
    train = {}
    test_first = True
    loc = r'C:\Users\cansu\OneDrive\Desktop\PAML_2024\data\colour_snippets'
