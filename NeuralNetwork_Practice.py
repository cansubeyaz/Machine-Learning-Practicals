...
Xf_train = Xf_train.reshape((60000, 28 * 28)).astype('float32') / 255 # normalize - scaling the input data
Xf_test = Xf_test.reshape((10000, 28 * 28)).astype('float32') / 255 # normalize - scaling the input data
...
# Plot accuracy
plt.subplot(1, 2, 2)
plt.plot(history_dict['categorical_accuracy'], label='Training accuracy')
plt.plot(history_dict['val_categorical_accuracy'], label='Validation accuracy')
